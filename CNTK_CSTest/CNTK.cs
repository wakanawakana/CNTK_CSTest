...
namespace WpfApplication1
{
    class CNTKAccess
    {
        public static void Test()
        {
            ...
            CNTKLibraryManagedExamples.EvaluateMultipleImagesInParallelAsync(DeviceDescriptor.CPUDevice);
...
//            CNTKLibraryManagedExamples.EvaluationBatchOfSequencesUsingOneHot(DeviceDescriptor.CPUDevice);
            ...
            CNTKLibraryManagedExamples.EvaluateMultipleImagesInParallelAsync(DeviceDescriptor.GPUDevice(0));
...
//                string modelFilePath = "cntk-unet.dnn";
